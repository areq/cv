...
\address{14 de Julio 1268, Buenos Aires, Argentina}{}
\phone{(+54) 0810 220 0046}
...
\cventry{2016}{Data Mining with R}{Eant New Technologies eant.tech}{}{}{}  % Arguments not required can be left empty
...
%------------------------------------------------
\cventry{2020 - Present}{Data Engineer}{\textsc{Nextroll} - nextroll.com}{USA}{}{Data Science team: We provide a solution for ads bidding price calculation and budget allocation problem for campaigns with real time calculations.
\newline{}\newline{}
Technologies Used:
\newline{} Python, Pandas, AWS Services, Presto, PostgreSQL, Docker.
}
%------------------------------------------------
\cventry{2017 - 2020}{Developer}{\textsc{Receptiviti} - receptiviti.ai}{Canada}{}{Web analytics platform that uses Neuro-linguistic programming to deliver the insights about organizations.
\newline{}\newline{}
Technologies Used:
\newline{} React, GraphQL, Python, Go, MongoDB, Docker, AWS Services.
}
%------------------------------------------------
\cventry{Nov 2016 - 2017}{Developer}{\textsc{Shado} - shado.tv}{Italy}{}{Develop an Android native application for direct sales.
\newline{}\newline{}
Technologies Used:
\newline{} Android.
}
...
\cvitemwithcomment{}{Backend}{Python, Nodejs, PHP}
\cvitemwithcomment{}{DataScience}{Jupyter Notebook, Presto, Scikit-learn, Apache spark, D3}
\cvitemwithcomment{}{FrontEnd}{React, Angular, Aurelia, Html, Css}
\cvitemwithcomment{}{Mobile}{React Native, Ionic, Android Native}
\cvitemwithcomment{}{Databases}{PostgreSQL, MongoDB, Redis}
\cvitemwithcomment{}{Infrastructure}{AWS Services, Docker, Ansible}
...
\cvitemwithcomment{English}{}{Conversationally fluent}
